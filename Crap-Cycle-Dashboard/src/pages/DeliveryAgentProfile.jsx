...
export default function DeliveryAgentProfile() {
    ...
    const confirmDelete = async () => {
        try {
            ...
            console.error('Error Delivery Agent:', err);
            toast.error("Error in Delivery Agent !");
        }
    };
    ...
    return (
        <Sidebar page={'Delivery Agent'}>
            <div className='flex justify-end text-xl font-bold mt-5'>
                <Link to='/dashboard/delivery_agent/add' className="bg-green-700 hover:bg-green-500 text-white font-bold py-2 px-4 rounded-3xl me-3">
                    + Add Agent
                </Link>
            </div>
            ...
            <div className='flex flex-col items-center h-4/6 w-4/5 mx-auto border-2 border-gray-400 rounded-3xl'>
                <img src={data.d_image ? agentImage : userImage} className='h-24  bg-cover mt-10 rounded-full' alt="User" />
                ...
                <div className='my-auto '>
                    ...
                    <button
                        ...
                        onClick={() => { navigate(`/dashboard/delivery_agent/edit/${id}`) }}
                    >
                        Edit
                    </button>
                    <button
                    ...
                    {data.d_document && (
                        <button
                            ...
                            className='bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-3xl m-4 w-32 w-32'
                        >
                            View PDF
                        </button>
                    )}
